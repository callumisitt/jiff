## Generated with 'brightbox-capify' on 2014-09-12 16:17:51 +0100
gem 'brightbox', '>=2.4.4'
...
set :domain, "jiff.test.white-agency.co.uk"

## List of servers
server "test.white-agency.co.uk", :app, :web, :db, :primary => true
...
set :scm, :git
set :branch, "develop"
set :scm_username, "WhiteAgency"
set :scm_password, "sw0rdf1sh88"
...
set :local_shared_dirs, %w{bin log tmp/pids tmp/cache tmp/sockets vendor/bundle}
...
set :default_environment, {
  'PATH' => "/home/rails/.rvm/gems/ruby-2.1.1/bin:/home/rails/.rvm/bin:/home/rails/.rvm/rubies/ruby-2.1.1/bin:$PATH",
  'RUBY_VERSION' => 'ruby-2.1.1',
  'GEM_HOME' => '/home/rails/.rvm/gems/ruby-2.1.1',
  'GEM_PATH' => '/home/rails/.rvm/gems/ruby-2.1.1',
}
